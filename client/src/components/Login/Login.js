...
const Login = () => {
  ...
  return (
    <Container component="main" maxWidth="xs" >
      ...
      <Paper className={classes.paper} elevation={2} style={{ backgroundColor: 'var(--blue-theme-background-color)', padding: '20px' }}>
        <Avatar className={classes.avatar} style={{ backgroundColor: 'var(--blue-theme-main-color)' }}>
          <LockOutlinedIcon  />
        </Avatar>
