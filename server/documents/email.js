...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    <body>
      ...
      <div class"footer">
          <a href="https://rahulmahto-myportfolio.vercel.app">
          <img class="footer-logo" src="/logo.png" alt="arc-invoice"/>
        </a>
      </div>
    <p style="text-align: center">Make beautiful invoice for free at https://rahulmahto-myportfolio.vercel.app</p>
    </div>
    </body>
</html>`
        ;
